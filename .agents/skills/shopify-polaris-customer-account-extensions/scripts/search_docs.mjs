...
var define_SUPPORTED_VERSIONS_default = ["2026-07", "2026-04", "2026-01", "2025-10", "2025-07"];
...
try {
  ...
  if (define_SUPPORTED_VERSIONS_default.length > 0) {
    const resolution = resolveVersion("polaris-customer-account-extensions", requestedApiVersion);
    if (!resolution.ok) {
      throw new Error(
